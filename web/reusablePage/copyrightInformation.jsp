...
<div class="copyrightInformation">
    ...
    <div class="thirdLine">
        <p>增值电信业务许可证：浙B2-20170717网络文化经营许可证：浙网文化经营许可证：
            浙网文[2015]0295-065号 互联网医疗保健信息服务 审核同意书 浙卫网审【2014】6号
            互联网药品信息服务资质证书编号：浙-（经营性）-2012-0005</p>
    </div>
    <div class="fourLine">
        <p>© 2003-2016 TMALL.COM 版权所有</p>
        <img src="../img/copyrightImg/copyRight1.jpg" >
        <img src="../img/copyrightImg/copyRight2.jpg" >
    </div>
</div>
</body>
</html>
